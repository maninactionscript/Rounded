                ...
                <form id="invoice_form">
                    ...
                    <div class="large-12 columns no-padding">
                        <div class="large-4 columns">
                            ...
                            <input type="text" value="{{$invoice->id == null ? $user->businessDetail->business_name : $invoice->company_name}}" name="company_name">
                        </div>
                        <div class="large-4 columns">
                            <label style="color: #000;">TO</label>
                            <label>Client name</label>
                            <input type="text" value="{{$invoice->id == null ? $client->business_name : $invoice->client_name}}" name="client_name">
                        </div>
                        <div class="large-4 columns">
                            <label>&nbsp;</label>
                            <label>invoice #</label>
                            {{--*/ $number = explode('-',$invoiceNumber) /*--}}
                            <span style="float: left; margin: 0.5rem 0.5rem 0px 0px;">{{$client->invoice_prefix}}</span> <input type="text" value="{{$number[1]}}" name="invoice_number">
                        </div>
                    </div>
                    <div class="large-12 columns no-padding">
                        <div class="large-4 columns">
                            <label>your name</label>
                            <input type="text" value="{{$invoice->id == null ? $user->businessDetail->name : $invoice->company_legal}}" name="company_legal">
                        </div>
                        <div class="large-4 columns">
                            <label>Contact name</label>
                            <input type="text" value="{{$invoice->id == null ? $client->contact_name : $invoice->client_legal}}" name="client_legal">
                        </div>
                        <div class="large-4 columns">
                    ...
                    <div class="large-12 columns no-padding">
                        <div class="large-4 columns">
                            <label>address</label>
                            <textarea name="company_address">{{ $invoice->id == null ? $user->businessDetail->address : $invoice->company_address}}</textarea>
                        </div>
                        <div class="large-4 columns">
                            <label>address</label>
                            <textarea name="client_address">{{ $invoice->id == null ? $client->address : $invoice->client_address }}</textarea>
                        </div>
                        <div class="large-4 columns">
                            ...
                            <span style="font-size: 0.8rem;">The invoice is due in</span> <input type="text" value="{{$invoice->id == null ? $invoiceSetting->payment_term : $invoice->payment_term}}" name="payment_term"> <span style="font-size: 0.8rem;">Days</span>
                        </div>
                    </div>
                    <div class="large-12 columns no-padding">
                        <div class="large-4 columns end">
                            <label>abn</label>
                            <input name="company_abn" value="{{$invoice->id == null ? $user->businessDetail->abn : $invoice->company_abn}}" type="text" />
                        </div>
                    </div>
                ...
                <ul class="button-group" style="padding: 0px;">
                    ...
                    <li class="customize-button" style="width: 20%;">
                        ...
                        <ul role="menu" class="dropdown-menu">
                            ...
                            @if($invoice->id != null)
                            <li><a href="#" data-id="{{$invoice->id}}" class="delete-invoice">detete</a></li>
                            @endif
                        </ul>
                    </li>
                </ul>
