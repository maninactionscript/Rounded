<div class="modal-header">
    <h4>SEND REMINDER {{$invoice->invoice_number}} TO {{$client->business_name}}</h4>
</div>
<div class="modal-body">
    <form class="send-invoice">
        ...
        <div class="row">
            ...
            <div class="large-12 columns">
                <label>subject</label>
                <input type="text" name="subject" value="{{$preview->reminder_subject}}">
            </div>
            <div class="large-12 columns">
                <label>mail</label>
                <textarea name="content">{{str_replace("<br>","\n",$preview->reminder_content)}}</textarea>
            </div>
            <div class="large-12 columns">
